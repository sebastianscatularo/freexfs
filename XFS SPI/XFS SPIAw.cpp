// XFS SPIaw.cpp : implementation file
//
...
void CXFSSPIAppWiz::InitCustomAppWiz()
{
...
void CXFSSPIAppWiz::ExitCustomAppWiz()
{
	// TODO: Add code here to deallocate resources used by the custom AppWizard
}

// This is called when the user clicks "Create..." on the New Project dialog
CAppWizStepDlg* CXFSSPIAppWiz::Next(CAppWizStepDlg* pDlg)
{
...
void CXFSSPIAppWiz::CustomizeProject(IBuildProject* pProject)
{
...
// Here we define one instance of the CXFSSPIAppWiz class.  You can access
//  m_Dictionary and any other public members of this class through the
//  global XFSSPIaw.
CXFSSPIAppWiz XFSSPIaw;
