...
HRESULT  WFPExecute ( HSERVICE hService, DWORD dwCommand, 
...
HRESULT  WFPOpen ( HSERVICE hService, LPSTR lpszLogicalName, 
				  ...
				  LPWFSVERSION lpSrvcVersion)
{
	...
	*pServiceBasic->m_lpRequestID = ReqID;
	...
	/*
	lpSrvcVersion->wVersion = 0x0003; //  This is the SPI version of this.
	lpSrvcVersion->wLowVersion = 0x0002;
	lpSrvcVersion->wHighVersion = 0xff03;

	strcpy(lpSrvcVersion->szDescription,"NewImage svr");
