...
BOOL CXFSField::Draw(CDC *pDC)
{
	...
	XFSGetSize(pDC,m_pRootForm->unit.m_strBase,CSize(position.m_wX,position.m_wY),CSize(m_pRootForm->unit.m_wX,\
		m_pRootForm->unit.m_wY),sizeOut,m_pRootForm->m_lXExt,m_pRootForm->m_lYExt);
