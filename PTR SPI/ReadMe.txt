========================================================================
                    CUSTOM APPWIZARD: PTR SPI
========================================================================


AppWizard has created a PTR SPI DLL for you.  This DLL is the starting point
...
you build PTR SPI.awx, it will automatically be copied to your Template
...
PTR SPIAw.h, PTR SPIAw.cpp - the CCustomAppWiz class
    These files contain your CCustomAppWiz-derived class,
    CPTRSPIAppWiz.  This class contains virtual member functions which
...
Template\
    ...
    import that file as a "TEMPLATE" custom resource into PTR SPI.rc.  Be
...
Template\NewProj.inf
    ...
    generated from the project "E:\SPIEpson20081017\epson2090spi.dsp".
...
off of the project "E:\SPIEpson20081017\epson2090spi.dsp".
...
StdAfx.h, StdAfx.cpp
    ...
    named PTR SPI.pch and a precompiled types file named StdAfx.obj.
