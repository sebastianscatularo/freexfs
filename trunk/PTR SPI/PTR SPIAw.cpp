// PTR SPIaw.cpp : implementation file
//
...
void CPTRSPIAppWiz::InitCustomAppWiz()
{
...
void CPTRSPIAppWiz::ExitCustomAppWiz()
{
	// TODO: Add code here to deallocate resources used by the custom AppWizard
}

// This is called when the user clicks "Create..." on the New Project dialog
CAppWizStepDlg* CPTRSPIAppWiz::Next(CAppWizStepDlg* pDlg)
{
...
void CPTRSPIAppWiz::CustomizeProject(IBuildProject* pProject)
{
...
// Here we define one instance of the CPTRSPIAppWiz class.  You can access
//  m_Dictionary and any other public members of this class through the
//  global PTRSPIaw.
CPTRSPIAppWiz PTRSPIaw;
