...
CXFSForm::CXFSForm():m_listFields(),m_listFrames(),m_listSubforms()
{
		...
		dwField = 0;////the number of fields
		dwFrame = 0;////the number of frames
		dwSubForm = 0;;////the number of subformnames;
		dwSize = 0;;//size of this struct 
